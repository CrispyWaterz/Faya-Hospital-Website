...
<body class=<img src="https://mybayutcdn.bayut.com/mybayut/wp-content/uploads/government-hospitals-in-Abu-Dhabi-31012020.jpg" alt=”FayaHospital”>
    ...
    <div class="color-gray mr-0">
        ...
        <div class="container row pt-25vh pl-5" id="homeButtonArea">
            ...
            <div class="col d-flex  text-center mt-3 mb-3 mr-5 ml-5">
                ...
                <div class="card pl-5">
                    <div class="card-body" style="padding-left: 100px; padding-right: 100px;">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control mb-3" id="useridData" value="<?php echo $user_data->userId; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label mb-3">Username</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="usernameData" value="<?php echo $user_data->username; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label mb-3">Email</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="emailData" value="<?php echo $user_data->email; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label">Department</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="departmentData" value="<?php echo $user_data->department; ?>" readonly>
                            </div>
                        </div>
                    </div>
